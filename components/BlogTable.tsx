        ...
        {blogs.map((blog: any) => {
          if (blog.featured) {
            return <div
              ...
              className="cursor-pointer group dark:bg-gray-700/25 bg-gray-300/50 rounded-lg ring-2 ring-transparent col-span-full grid grid-cols-12 py-14 hover:ring-red-400 hover:ring-offset-4 dark:ring-offset-[#1d010a]   dark:hover:ring-yellow-400 transition-all duration-300"
              id="target-section">
